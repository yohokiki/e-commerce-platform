        ...
        <div>
          <div class="goods-info">
            ...
            <div class="spec">
              ...
              <!-- 数据组件 -->
              <el-input-number v-model="count" @click="changeCount(count)" />
              <!-- 按钮组件 -->
              <div>
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                  <img v-for="pic in goods.details?.pictures" v-img-lazy="pic" :key="pic">
                </div>
              </div>
            </div>
            <!-- 24热榜+专题推荐 -->
            <div class="goods-aside">
              <!-- <div><span>24小时热榜</span></div>
              <GoodsItem v-for="commodity in goods" :goods="commodity" :key="commodity.id"></GoodsItem> -->
