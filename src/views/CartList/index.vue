 ...
 * @param flag 
 */
const singleCheck = (goods, flag) => {
  useStore.singleCheck(goods.skuId, flag)
...
const count = ref(0)
watchEffect(() => {
  count.value = useStore.allCount
  sumCount.value = useStore.chosenCount
  sumPrice.value = useStore.chosenPrice
})
// console.log(useStore.chosenList)
    ...
    <div class="container m-top-20">
      <div class="cart">
        <table>
          ...
          <!-- 商品列表 -->
          <tbody>
            <tr v-for="i in useStore.cartList" :key="i.skuId">
              <td>
                <el-checkbox :model-value="i.selected" @change="(flag) => singleCheck(i, flag)" />
              </td>
              <td>
                <div class="goods">
